...
@section('content')
                ...
                <div class="col-md-5 col-lg-4 order-md-last">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <a href="bandrekandaliman@gmail.com" target="_blank"><button type="button" class="btn btn-primary btn-lg btn-floating" style="background-color: #dd4b39;">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <a href="https://www.facebook.com/bandrekandaliman/" target="_blank"><button type="button" class="btn btn-primary btn-lg btn-floating">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <!-- Instagram -->
                            <a href="https://instagram.com/bandrek_andaliman?igshid=YmMyMTA2M2Y=" target="_blank"><button type="button" class="btn btn-primary btn-lg btn-floating" style="background-color: #ac2bac;">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            ...
                            <a href="" target="_blank"><button type="button" class="btn btn-primary btn-lg btn-floating" style="background-color: #25d366;">
    ...
    <div class="map">
        ...
        <iframe
            ...
            width="1520" height="550" style="border:0;" allowfullscreen="" loading="lazy"
